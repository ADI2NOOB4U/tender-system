...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* ✅ FIX: Move font import here (prevents hydration error) */}
        <link
          href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;400;500;600;700&family=DM+Mono:wght@400;500&display=swap"
          rel="stylesheet"
        />
      </head>
        ...
        <header className="bg-white border-b-2 border-gov-blue shadow-sm">
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-5">
            ...
            <div className="w-14 h-14 border-2 border-gov-navy rounded-full flex items-center justify-center flex-shrink-0">
              <svg
                viewBox="0 0 40 40"
                className="w-9 h-9 text-gov-navy"
                fill="currentColor"
              >
                <circle
                  cx="20"
            ...
            <div>
              <div className="text-gov-navy font-bold text-lg tracking-wide">
            ...
            <div className="ml-auto text-right hidden md:block">
              ...
              <div className="text-xs font-mono font-semibold text-gov-navy">
                TES/2024-25/GOI
              </div>
            </div>
          </div>
          ...
          <nav className="border-t border-gray-200 bg-gray-50">
            <div className="max-w-6xl mx-auto px-6">
              <ul className="flex text-xs font-semibold tracking-wide">
                {[
                  "Home",
                  "Upload Tender",
                  "Job Status",
        ...
        <footer className="bg-gov-navy text-white mt-auto">
          <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-2 text-xs opacity-80">
            ...
            <span className="tracking-wide">
              Best viewed in Chrome v100+ &nbsp;|&nbsp; 1280×768 resolution
              &nbsp;|&nbsp; Version 3.2.1
            </span>
          </div>
        </footer>
